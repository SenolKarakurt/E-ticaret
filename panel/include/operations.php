                ...
                <div class="col-md-3 col-sm-3 col-xs-3">
                    <ul class="nav nav-tabs tabs-left">
                        ...
                        foreach ($getAddress as $getAddress2){
                            echo'
                             <li class="';if($aa == "0"){echo"active";} echo'">
...
function customerSelect(){
    ...
    foreach ($customerSelect as $getCustomer){
        echo'<option value="'.$getCustomer["pr_id"].'">'; if($getCustomer["companyname"]==""){echo $getCustomer["firstname"];}else{echo $getCustomer["companyname"];} echo'</option>';
    }
}
